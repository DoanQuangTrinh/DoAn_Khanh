      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
        ...
        >
          ...
          <p className="font-text-content text-lg text-gray-700 leading-relaxed">
            Vui lòng chọn phương thức thanh toán phù hợp để hoàn tất việc giữ
            chỗ cho bé. Quý phụ huynh có thể thanh toán qua Momo, Chuyển khoản
            hoặc Thẻ ngân hàng. Mọi thông tin thanh toán đều được mã hóa và an
            toàn tuyệt đối.
          </p>
