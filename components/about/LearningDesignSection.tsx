        ...
        <div className="flex flex-wrap w-full">
          ...
          <div className="flex-1 md:col-span-2 px-4 py-4 md:py-0 flex flex-col justify-center">
            ...
            <p className="font-text-content-min text-lg leading-relaxed mb-8">
              Mỗi workshop áp dụng phương pháp "learning by doing", lồng ghép
              yếu tố STEAM phù hợp với từng độ tuổi gồm 5 đến 6, 7 đến 9, 10 đến
              12. Trẻ đi trọn quy trình quan sát, lên ý tưởng, thử nghiệm vật
              liệu, lắp ghép, tinh chỉnh và hoàn thiện. Kết thúc buổi, trẻ mang
              đồ chơi xanh về nhà kèm hướng dẫn ngắn để có thể tiếp tục sáng tạo
              tại nhà.
            </p>
            ...
            <div>
              <button
                ...
                className="group bg-brand-dark-button text-white text-lg px-8 py-3 rounded-xl button-workshop text-workshop flex items-center gap-3 hover:opacity-90 transition-all"
              >
                Tham khảo Workshop
                <ArrowRightIcon />
              </button>
