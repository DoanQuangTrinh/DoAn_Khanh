        ...
        <div className="w-full pt-12">
            <div className="flex flex-col-reverse lg:flex-row items-center justify-around gap-8 lg:gap-16 ">
                <div className=" lg:w-2/5 md:text-right text-center font-sans flex flex-col px-4 md:px-0  gap-6">
                    ...
                    <ul className="list-disc list-inside font-text-content text-lg space-y-2">
                        <li>Tái chế sáng tạo - 100% vật liệu thân thiện, an toàn cho trẻ.</li>
                        <li>Chủ đề mới mỗi tuần luân hấp dẫn và khơi gợi trí tưởng tượng.</li>
                        <li>Kết nối gia đình - phụ huynh cùng con học, cùng con chơi.</li>
                        <li>Đối tác tin cậy được nhiều trường học và doanh nghiệp
                            lựa chọn cho hoạt động giáo dục xanh.</li>
                    </ul>
            ...
            <div className="flex text-center justify-center py-8 px-6">
                <p className="font-text-content  container">
                    GreenKids ra đời tại Đà Nẵng (2024), được thành lập bởi nhóm chuyên gia giáo dục, môi trường và thiết kế.
                    Chúng tôi mong muốn đưa hành động "sống xanh" vượt qua lý thuyết, giúp trẻ em trực tiếp trải nghiệm và
                    thực hành bảo vệ môi trường bằng chính đôi tay mình.
                </p>
            </div>
        </div>
    );
