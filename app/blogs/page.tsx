            ...
            <div className="max-w-4xl mx-auto py-16 px-4">
                ...
                <div className="space-y-12">
                    {posts.map((post) => (
                        ...
                        >
                            {/* Ảnh bìa */}
                            <Link href={`/blogs/${post.slug}`} className="md:col-span-1 block overflow-hidden rounded-xl">
                                <img
                                    src={post.imageUrl}
                                    alt={post.title}
                            ...
                            <div className="md:col-span-2">
                                ...
                                <h2 className="font-serif text-3xl font-bold text-brand-dark mb-3">
                                    <Link href={`/blogs/${post.slug}`} className="text-about text-4xl md:text-5xl font-medium leading-tight">
                                        {post.title}
                                    </Link>
                                </h2>
                                <p className="block text-sm font-text-content mb-2 font-text-content-min">
                                    {post.excerpt}
                                </p>
                                <Link
